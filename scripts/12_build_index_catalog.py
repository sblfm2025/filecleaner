"""
scripts/12_build_index_catalog.py — Pembangun Katalog Master & Playlists M3U v4.0
=================================================================================
Skrip CLI stasiun radio untuk menjalankan proses pembangunan katalog master stasiun radio
dan memetakan seluruh playlist logis M3U di folder 20_INDEX_CATALOG/ secara dinamis.

Penggunaan:
    python scripts/12_build_index_catalog.py
"""
...
def main(
    ...
    """
    logger.info("======================================================================")
    logger.info("   MEMULAI PEMBANGUNAN KATALOG MASTER & PLAYLISTS M3U v4.0")
    logger.info("======================================================================")
